...
def plotvariable(tsk):
    ...
    p.AddSample("TTToSemiLeptonic_*",           "Non-W/Z",      r.itBkg, 413, systlist)
    p.AddSample("WJetsToLNu_MLM_*",             "Non-W/Z",      r.itBkg, 413, systlist)
    ...
    p.AddSample("TTWJetsToLNu",                 "VV+t#bar{t}V", r.itBkg, 390, systlist);
    p.AddSample("TTWJetsToQQ",                  "VV+t#bar{t}V", r.itBkg, 390, systlist);
    p.AddSample("TTZToQQ",                      "VV+t#bar{t}V", r.itBkg, 390, systlist);
    p.AddSample("TTZToLLNuNu_M_10",             "VV+t#bar{t}V", r.itBkg, 390, systlist);
    p.AddSample("TTZToLL_M_1to10",              "VV+t#bar{t}V", r.itBkg, 390, systlist);
    ...
    p.AddSample("DYJetsToLL_M_10to50_MLM_*",    "DY",           r.itBkg, 852, systlist);
    p.AddSample("DYJetsToLL_M_50_*",            "DY",           r.itBkg, 852, systlist);
    ...
    p.AddSample("MuonEG_2018_*",                "Data",         r.itData);
    p.AddSample("SingleMuon_2018_*",            "Data",         r.itData);
    p.AddSample("EGamma_2018_*",                "Data",         r.itData);
    ...
    #pdf     = r.PDFToPy(r.TString(pathToTree), r.TString("TTbar_Powheg"), r.TString(NameOfTree), r.TString(cutdir[cut]), r.TString(chan), r.TString(vl.varList[var]['var']), nbins, lowedge, highedge);
    #pdf.verbose = False
...
def plotdressvariable(tsk):
    ...
    #pdf     = r.PDFToPy(r.TString(pathToTree), r.TString("TTbar_Powheg"), r.TString(NameOfTree), r.TString(cutdir["Dress" + cut]), r.TString(chan), r.TString(vl.varList[var]['var']), nbins, lowedge, highedge);
    #pdf.verbose = False
    #pdf.SetLumi(vl.Lumi * 1000)
    #if doPrefChecks: pdf.SetWeight("TWeight * (1 - prefWeight)")
    #hPDFUp  = pdf.GetSystHisto("up","pdf").CloneHisto();
...
def plotcustomvariable(tsk):
    ...
    pdf     = r.PDFToPyC(r.TString(pathToTree), r.TString("TTbar_Powheg"), r.TString(NameOfTree), r.TString(cutdir[cut]), r.TString(chan), r.TString(vl.varList[var]['var']), len(vl.varList[var]['recobinning']) - 1, binning, r.TString(''));
    pdf.verbose = False
    #pdf.verbose = True
    pdf.SetLumi(vl.Lumi * 1000)
    if doPrefChecks: pdf.SetWeight("TWeight * (1 - prefWeight)")
...
def plotthenumberofjets(tsk):
    ...
    #pdf     = r.PDFToPyC(r.TString(pathToTree), r.TString("TTbar_Powheg"), r.TString(NameOfTree), r.TString(cutdir[cut]), r.TString(chan), r.TString(vl.varList[var]['var'] + "- 1"), len(vl.varList[var]['recobinning']) - 1, binning, r.TString(''));
    #pdf.verbose = False
    ##pdf.verbose = True
    #pdf.SetLumi(vl.Lumi * 1000)
    #if doPrefChecks: pdf.SetWeight("TWeight * (1 - prefWeight)")
...
if __name__ == '__main__':
    ...
    for chn in ["ElMu"]:
        for lvl in ["detector", "particle"]:
            tasks.append(("Lep1_Pt",       "SR",   chn, "descriptive", lvl))
            tasks.append(("Lep1_Eta",      "SR",   chn, "descriptive", lvl))
            tasks.append(("Lep2_Pt",       "SR",   chn, "descriptive", lvl))
            tasks.append(("Lep2_Eta",      "SR",   chn, "descriptive", lvl))
            tasks.append(("LepMuon_Pt",    "SR",   chn, "descriptive", lvl))
            tasks.append(("LepMuon_Eta",   "SR",   chn, "descriptive", lvl))
            tasks.append(("LepElec_Pt",    "SR",   chn, "descriptive", lvl))
            tasks.append(("LepElec_Eta",   "SR",   chn, "descriptive", lvl))
            tasks.append(("Jet1_Pt",       "SR",   chn, "descriptive", lvl))
            tasks.append(("Jet1_Eta",      "SR",   chn, "descriptive", lvl))
            tasks.append(("Lep1Lep2_DPhi", "SR",   chn, "descriptive", lvl))
            tasks.append(("Sys_Pt",        "SR",   chn, "descriptive", lvl))
            tasks.append(("Sys_M",         "SR",   chn, "descriptive", lvl))
            tasks.append(("Jet2_Pt",       "2j1b", chn, "descriptive", lvl))
        tasks.append(("HTtot",         "SR",   chn, "descriptive", "detector"))
        tasks.append(("C_jll",         "SR",   chn, "descriptive", "detector"))
        tasks.append(("Lep1Lep2_HTOverHTtot","SR",chn,"descriptive","detector"))
        tasks.append(("LooseCentral1_Pt","SR", chn,"descriptive", "detector"))
        tasks.append(("Sys_PtOverHTtot","SR",  chn, "descriptive", "detector"))
        tasks.append(("Lep1Lep2Jet1_Pt","SR",  chn, "descriptive", "detector"))
        tasks.append(("BDT",           "SR",   chn, "descriptive", "detector"))
        tasks.append(("NLooseCentral", "1j1b", chn, "descriptive", "detector"))
        tasks.append(("NBLooseCentral","1j1b", chn, "descriptive", "detector"))
        tasks.append(("Lep1Jet1_DR",   "2j1b", chn, "descriptive", "detector"))
        tasks.append(("Lep12Jet12_DR", "2j1b", chn, "descriptive", "detector"))
        tasks.append(("Lep12Jet12MET_DR","2j1b",chn,"descriptive", "detector"))
        tasks.append(("BDT2j1b",       "2j1b", chn, "descriptive", "detector"))

        tasks.append(("Jet1_Eta",      "SR",   chn, "descriptive", "detector"))
