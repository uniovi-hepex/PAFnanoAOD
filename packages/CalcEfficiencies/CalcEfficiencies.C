#include "CalcEfficiencies.h"

ClassImp(CalcEfficiencies);
CalcEfficiencies::CalcEfficiencies() : PAFChainItemSelector() {}
void CalcEfficiencies::Summary(){}

void CalcEfficiencies::Initialise(){
...
void CalcEfficiencies::InsideLoop(){
...
void CalcEfficiencies::SetLeptonVariables(){
...
void CalcEfficiencies::SetJetVariables(){
...
void CalcEfficiencies::SetEventVariables(){
...
void CalcEfficiencies::GetLeptonVariables(std::vector<Lepton> selLeptons, Int_t nVetoLeptons){
...
void CalcEfficiencies::GetJetVariables(std::vector<Jet> selJets, std::vector<Jet> cleanedJets15, Float_t ptCut){
